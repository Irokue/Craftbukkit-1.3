...
public class Block {
    ...
    // Sweetcraft -- Ajouts des blocs !
    public static final Block CHAISE = (new BlockChaise(200, 4)).c(2.0F).b(5F).a(e).b("chaise");
    public static final Block TABLE = (new BlockTable(201, 4)).c(2.0F).b(5F).a(e).b("table");
    public static final Block X = (new BlockX(202, 203)).c(99999999999F).q().a(j).b("x");
    public static final Block COAL_BLOCK = (new BlockOreBlock(203, 26)).c(5.0F).b(10.0F).a(i).b("blockCoal");
    public static final Block REDSTONE_BLOCK = (new BlockRedstoneBlock(204, 26, false)).c(5.0F).b(10.0F).a(i).b("blockRedstone");
    public static final Block GLOWING_REDSTONE_BLOCK = (new BlockRedstoneBlock(205, 26, true)).c(5.0F).b(10.0F).a(i).b("blockRedstone");
    public static final Block GRAPPE_CROPS = new BlockGrappeCrops(206, 170).c(0.0F).a(g).b("grappeCrops").v().p();
    public static final Block FOIN = new Block(207, 184, Material.CLOTH).c(0.8F).a(k).b("foin");
    public static final Block FOIN_STAIRS = new BlockStairs(208, FOIN, 0).c(0.8F).a(k).b("stairsFoin");
    public static final Block ORGE_CROPS = (new BlockCropsOrge(209, 88)).c(0.0F).a(g).b("orgeCrops").v().p();
    public static final Block NUAGE = (new BlockNuage(210,235,Material.CLOTH,false)).q().b(6000000F).a(k).b("nuage");
    public static final Block TAPIS = (new BlockTapis(211, 64)).c(0.5F).a(k).b("tapis");
    public static final Block BRICK_FENCE = (new BlockFence(212, 7, Material.STONE)).c(2.0F).a(h).b(10F).b("barriereBrique");
    public static final Block DALLE_LAINE = (new BlockDalleLaine(213, true)).c(0.8F).a(k).b("dalleLaine");
    public static final Block DEMI_DALLE_LAINE = (new BlockDalleLaine(214, false)).c(0.8F).a(k).b("demiDalleLaine");
    public static final Block DEMI_DALLE_LAINE_ENVERS = (new BlockDalleLaineEnvers(215, false)).c(0.8F).a(k).b("demiDalleLaine");
    public static final Block LEAVES_POMMIER = (BlockLeavesPommier) (new BlockLeavesPommier(216, 52)).c(0.2F).h(1).a(g).b("leaves").p();
    public static final BlockFlower PINK_FLOWER = (BlockFlower) (new BlockFlower(217, 236)).c(0.0F).a(g).b("flower");
    public static final BlockFlower LOVE_FLOWER = (BlockFlower) (new BlockFlower(218, 220)).c(0.0F).a(g).b("flower");
    public static final BlockFlower WHITE_FLOWER = (BlockFlower) (new BlockFlower(219, 221)).c(0.0F).a(g).b("flower");
    public static final BlockFlower BLUE_FLOWER = (BlockFlower) (new BlockFlower(220, 219)).c(0.0F).a(g).b("flower");
    public static final BlockFlower ORANGE_FLOWER = (BlockFlower) (new BlockFlower(221, 218)).c(0.0F).a(g).b("flower");
    ...
    static {
    	Item.byId[TAPIS.id] = (new ItemSlabLaine(TAPIS.id - 256)).b("tapis");
    	Item.byId[DEMI_DALLE_LAINE.id] = (new ItemSlabLaine(DEMI_DALLE_LAINE.id - 256)).b("demiDalleLaine");
