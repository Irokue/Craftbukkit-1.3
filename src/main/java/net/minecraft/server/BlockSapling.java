...
public class BlockSapling extends BlockFlower {
    ...
    public static final String[] a = new String[] { "oak", "spruce", "birch", "jungle", "pommier"};
    ...
    public int a(int i, int j) {
        j &= 7;
        return j == 1 ? 63 : (j == 2 ? 79 : (j == 3 ? 30 : (j == 4 ? 215 : super.a(i, j))));
    }
    ...
    public boolean e(World world, int i, int j, int k, int l) {
        return world.getTypeId(i, j, k) == this.id && (world.getData(i, j, k) & 7) == l;
    }
