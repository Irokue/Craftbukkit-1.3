...
public class RecipeIngots {
    ...
    public void a(CraftingManager craftingmanager) {
        ...
        craftingmanager.registerShapedRecipe(new ItemStack(Block.FOIN, 3), new Object[] { "###", "###", "###", Character.valueOf('#'), Item.WHEAT});
        craftingmanager.registerShapedRecipe(new ItemStack(Item.WHEAT, 3), new Object[] { "#", Character.valueOf('#'), Block.FOIN });
