...
public class NetLoginHandler extends NetHandler {
    ...
    public void a(Packet2Handshake packet2handshake) {
        ...
        if (!this.h.equals(StripColor.a(this.h))) {
            ...
            if (packet2handshake.d() != 75) {
                if (packet2handshake.d() < 75) {
                    this.disconnect( ChatColor.YELLOW +"Merci de télécharger le client de "+ ChatColor.GREEN +"Sweet"+ ChatColor.GOLD +"craft" + ChatColor.YELLOW +".");
                } else {
                    this.disconnect( ChatColor.YELLOW +"Merci de mettre à jour ou de télécharger le client "+ ChatColor.GREEN +"Sweet"+ ChatColor.GOLD +"craft" + ChatColor.YELLOW +".");
                }
            } else {
