...
public class Item {
    ...
    public static Item MAILLE = new ItemMaille(500).b(13, 11).b("maille");
    public static Item RAISIN = new ItemRaisin(501, 6, false).b(11, 11).b("raisin");
    public static Item RAISIN_SEED = new ItemSeeds(502, Block.GRAPPE_CROPS.id, Block.SOIL.id).b(10, 11).b("raisinSeeds");
    public static Item VIN = new ItemVin(503).a(MobEffectList.CONFUSION.id, 20, 0, 1.0F).i().b(12, 11).b("vin");
    public static Item VIN_VIDE = new Item(504).b(12, 12).b("vinVide");
    public static Item CHOPE_BIERE = (new ItemBiere(505)).i().a(MobEffectList.CONFUSION.id, 20, 0, 1.0F).b(5, 12).b("chopeBière").a(CreativeModeTab.h);
    public static Item CHOPE_VIDE = (new Item(506)).b(5, 9).b("chopeVide").a(CreativeModeTab.h);
    public static Item SEED_ORGE = new ItemSeeds(507, Block.ORGE_CROPS.id, Block.SOIL.id).b(9, 11).b("seedOrge").a(CreativeModeTab.h);
    public static Item ORGE = new Item(508).b(5, 10).b("Orge").a(CreativeModeTab.l);
    public static Item LIQUIDE_SUSPECT = (new ItemLiquideSuspect(509)).i().a(MobEffectList.CONFUSION.id, 60, 1, 1.0F).b(5, 11).b("liquideSuspect").a(CreativeModeTab.h);
    public static Item BOL_LAIT = (new ItemSoup(510, 9)).b(5, 13).b("Bol de lait").a(CreativeModeTab.h);
