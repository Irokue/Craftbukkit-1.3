...
public class BlockLeavesPommier extends BlockTransparant {

    private int cr;
    public static final String[] a = new String[] { "oak", "spruce", "birch", "jungle"};
    int[] b;

    protected BlockLeavesPommier(int i, int j) {
                    ...
                    for (l1 = -b0; l1 <= b0; ++l1) {
                        for (i2 = -b0; i2 <= b0; ++i2) {
                            for (j2 = -b0; j2 <= b0; ++j2) {
                                ...
                                } else if (k2 == Block.LEAVES_POMMIER.id) {
    ...
    public void a(World world, EntityHuman entityhuman, int i, int j, int k, int l) {
        if (!world.isStatic && entityhuman.bC() != null && entityhuman.bC().id == Item.SHEARS.id) {
            ...
            this.a(world, i, j, k, new ItemStack(Block.LEAVES_POMMIER.id, 1, l & 3));
        } else {
